...
const CampaignManager = {
    ...
    projectKnowledge: {
        ...
        // ==========================================
        campaignProducts: [
            // المرحلة 1: التهيئة والتشويق (1-14 يناير 2026)
            {
                id: 'p1',
                phase: 1,
            ...
            // المرحلة 2: الإطلاق الاستراتيجي (15-20 يناير 2026)
            {
                id: 'p6',
                phase: 2,
            ...
            // المرحلة 3: ترسيخ الريادة (21-31 يناير 2026)
            {
                id: 'p13',
                phase: 3,
...
**📌 المرحلة 1: التهيئة والتشويق (1-14 يناير)**
${phase1.map(p => `• **${p.title}** - ${p.platform}
   📅 ${p.date} | 🎯 ${p.objective}`).join('\n')}

**🚀 المرحلة 2: الإطلاق الاستراتيجي (15-20 يناير)**
${phase2.map(p => `• **${p.title}** - ${p.platform}
   📅 ${p.date} | 🎯 ${p.objective}`).join('\n')}

**🏆 المرحلة 3: ترسيخ الريادة (21-31 يناير)**
